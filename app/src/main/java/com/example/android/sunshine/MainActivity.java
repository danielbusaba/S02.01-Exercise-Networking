...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData()
    {
        ...
        new LocationQueryTask().execute(locationQuery);
    }
    ...
    public class LocationQueryTask extends AsyncTask<String, Void, String []>
    {
        ...
        protected String [] doInBackground(String... params)
        {
            ...
            try
            {
                locationSearchResults = NetworkUtils.getResponseFromHttpUrl(searchURL);
                weather = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, locationSearchResults);
            }
            catch (Exception e)
            {
                e.printStackTrace();
        ...
        protected void onPostExecute(String [] locationSearchResults)
        {
            ...
            {
                for (String forecast : locationSearchResults)
                {
            ...
            {
                mWeatherTextView.setText("Error retrieving weather");
            }
        }
    }
